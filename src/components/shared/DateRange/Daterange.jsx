...
const Daterange = () => {
    ...
    // className='absolute left-1 pl-3 pointer-events-none flex items-center gap-4 p-3'

    return (
    <div>
        <div ref={newPopRef} className='cursor-pointer group'>
          <div onClick={handleNewPopup} className=' bg-white w-[300px] h-[60px] border border-b rounded-lg border-gray-400 flex items-center group-hover:border-blue-500 p-3'>

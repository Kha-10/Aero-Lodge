...
const Daterange = ({handleNewPopup,setNewPopup,newPopup}) => {
    ...
    <div>
        <div ref={newPopRef} className='cursor-pointer group'>
          <div onClick={handleNewPopup} className='relative bg-white w-[300px] h-[60px] border border-b rounded-lg z-50 border-gray-400 flex items-center justify-around group-hover:border-blue-500 p-3'>
